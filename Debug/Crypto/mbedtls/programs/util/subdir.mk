...
C_SRCS += \
../Crypto/mbedtls/programs/util/pem2der.c \
../Crypto/mbedtls/programs/util/strerror.c 

OBJS += \
./Crypto/mbedtls/programs/util/pem2der.o \
./Crypto/mbedtls/programs/util/strerror.o 

C_DEPS += \
./Crypto/mbedtls/programs/util/pem2der.d \
./Crypto/mbedtls/programs/util/strerror.d 


# Each subdirectory must supply rules for building sources it contributes
Crypto/mbedtls/programs/util/%.o: ../Crypto/mbedtls/programs/util/%.c Crypto/mbedtls/programs/util/subdir.mk
